...
from typing import Dict, Any, List, Type, TypeVar, cast
from .base import BaseAPIClient, ResponseValidationError
...
class UnifiClient(BaseAPIClient):
    ...
    # Client Management
    def get_client(self, mac: str) -> Device:
        """
        ...
        Returns:
            Device: A Device object containing detailed information about the specified network client.
    ...
    def get_clients(self) -> List[Device]:
        """
        ...
        the site-specific statistics endpoint. Each client is instantiated as a Device object.

        Returns:
            List[Device]: A list of Device objects representing all connected network clients.
